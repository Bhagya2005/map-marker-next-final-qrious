...
import WalkthroughsManagement from "@/app/_components/admin/modules/WalkthroughsManagement";
    ...
    <div className="flex h-screen bg-zinc-900">
      <div className="flex-1 flex flex-col overflow-hidden">
        <header className="bg-white/5 border-b border-white/10 p-4 flex justify-between items-center">
          <h1 className="text-2xl font-bold text-white">Walkthroughs Management</h1>
          <button
